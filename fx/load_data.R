...
load_data <- function() {
  ...
  male_prev_sa  <- t(read_excel(paste0(getwd(), "/data-public/male-hiv-prevalence-sa.xlsx"),
                                col_names = T))
  
  male_prev_uga <- t(read_excel(paste0(getwd(), "/data-public/male-hiv-prevalence-uga.xlsx"),
                                col_names = T))
  
  male_prev_zim <- t(read_excel(paste0(getwd(), "/data-public/male-hiv-prevalence-zim.xlsx"),
                                 col_names = T))
